...
namespace _3_Semester_CSharpMath_WPF.ViewModels.Pages.NewtonMethodPage
{
    partial class NewtonMethodPageViewModel : ObservableObject
    {
        ...
        public void SolveFunction()
        {
            ...
            try
            {
                (startLimitDouble, endLimitDouble, toleranceDouble, countIterationsInt) = Helpers.CheckExceptions(userMathFunction: UserMathFunction, startLimit: StartLimit, endLimit: EndLimit, tolerance: Tolerance,
                                                                                        ...
                                                                                        toleranceDouble: toleranceDouble, countIterationsInt: countIterationsInt);
